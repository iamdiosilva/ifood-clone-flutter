...
class BottomNavigatorComponent extends StatelessWidget {
  final List<BottomNavigatorItemComponent> bottomItems;
  final int currentIndex;
  final Function(int) onTap;

  const BottomNavigatorComponent({Key? key, required this.bottomItems, this.currentIndex = 0, required this.onTap}) : super(key: key);
          ...
          Padding(
            ...
            child: Row(
              ...
              children: bottomItems
                  .map((e) => e.copyWith(
                        isActive: bottomItems.indexOf(e) == currentIndex,
                        onTap: () => onTap(bottomItems.indexOf(e)),
                      ))
                  .toList(),
            ),
          ),
